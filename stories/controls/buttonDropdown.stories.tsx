      ...
      <section>
        <div className="section-relative">
          ...
          >
            ...
            >
              <Button variant="add">Add smth</Button>
              <SelectList fixActive={false}>
                ...
                <Divider />
                <SelectListItem icon="archive" list="List">
                  Card name
                </SelectListItem>
              </SelectList>
            </ButtonDropdown>
            ...
            >
              ...
              <SelectList fixActive={false}>
                <li onClick={onClickHandler}>Copy card</li>
          ...
          <ButtonDropdown dropdownClassName={"stories-dropdown-visible"}>
            <Button>Dropdown with select</Button>
            <Select
              options={Array.from({ length: 10 }, (val, i) => ({
                value: i + 1,
              }))}
              variant={"arrow"}
              onChange={() => {}}
      ...
      <section className="section-relative section-grey section-portal">
        ...
        >
          ...
          >
            ...
            <SelectList fixActive={false}>
              <SelectListItem icon="card" list="List Ut enim ad minim veniam!">
                Card Lorem ipsum dolor sit amet?
              </SelectListItem>
              <SelectListItem icon="archive" list="List">
                Card name
      ...
      <section className="section-form-min">
        ...
        >
          ...
          <SelectList fixActive={false}>
            ...
            >
              <SelectListItem>
                <Userpic size={24} src="https://i.pravatar.cc/48?u=1" />
                User01
              </SelectListItem>
            </Checkbox>
            <Checkbox
            ...
            >
              <SelectListItem>
                <Userpic size={24} src="https://i.pravatar.cc/48?u=2" />
...
export const _ButtonDropdown = () => <Story />;
