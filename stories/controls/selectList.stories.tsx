    ...
    <div className="page">
      <section className="section-form-min">
        ...
        <SelectList fixActive={false}>
          <li>Copy card</li>
          <li className="divider">Print card</li>
          <li className="divider someClass">Get link to card</li>
          <li className="disabled">Delete card</li>
        </SelectList>
        <br />
        <br />
        <h2>iconSize 24</h2>
        <SelectList fixActive={false}>
          <SelectListItem icon={"copy"} iconSize={24}>
            Copy card
          </SelectListItem>
          <SelectListItem className="divider" icon={"print"} iconSize={24}>
            Print card
          </SelectListItem>
          <SelectListItem
          ...
          <SelectListItem icon={"delete"} iconSize={24}>
            Delete card
          </SelectListItem>
        </SelectList>
        <br />
...
export const _SelectList = () => <Story />;
