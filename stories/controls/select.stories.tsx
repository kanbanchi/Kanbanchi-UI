  ...
  const filterSearchOptions = (i: ISelectActiveInheritedProps) => {
    if (i.item) {
      const index = searchOptions.findIndex(
        (option) => String(option.value) === String(i.item.value),
      );
      ...
      searchFiltered[i.item.index].active =
        !searchFiltered[i.item.index].active;
      ...
      <section className="section-form-min">
        ...
        >
          <SelectList fixActive={false}>
            <SelectListItem className={"disabled"}>Title01</SelectListItem>
            <Checkbox
              checked={val01}
              color="light"
              value="1"
            ...
            <SelectListItem className={"disabled"}>Title02</SelectListItem>
            <Checkbox
              checked={val06}
              color="light"
              value="6"
        ...
        >
          <SelectList>
            ...
            <li value="pm">Professional monthly</li>
          </SelectList>
        </Select>
