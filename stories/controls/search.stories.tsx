      ...
      setTimeout(() => {
        if (success) {
          val.push(
            ...
            >
              Card Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
              do eiusmod tempor incididunt ut labore et dolore magna aliqua.
            </SelectListItem>,
          );
          val.push(
            <SelectListItem key="1" icon="archive" list="List">
              Card name
            </SelectListItem>,
          );
          val.push(
          ...
          val.push(
            <SelectListItem key="3" icon="archive" list="List">
              Card name
            </SelectListItem>,
          );
        } else {
          val.push(<SelectListItem>¯\_(ツ)_/¯</SelectListItem>);
        }
        setLoading(false);
        ...
        <div className="section-relative">
          ...
          >
            <SelectList fixActive={false}>
              ...
              <SelectListItem icon="archive" list="List" value="id02">
                Card name
              </SelectListItem>
              <SelectListItem
                icon="card"
