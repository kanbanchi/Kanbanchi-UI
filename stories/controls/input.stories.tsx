  ...
  return (
    <div className="page">
      ...
      <section className="section-form-min">
        ...
        <Input isClearable={true} label={"Default isClearable"} />

        <br />

        <Input label={"Default"} value={"Default filled"} />

        <br />

        <Input label={"Default"} value={"Variant arrow"} variant={"arrow"} />
        ...
        <Input label={"Readonly"} readOnly={true} />

        <br />

        <Input label={"Readonly"} readOnly={true} value="Readonly filled" />
        ...
        <Input label={"Disabled"} disabled={true} value="Disabled filled" />
      ...
      <section className="section-form-min">
        ...
        <Input label={"Default"} value={"Default filled"} size={"small"} />
        ...
        <Input label={"Readonly"} readOnly={true} size={"small"} />
        ...
        <Input label={"Disabled"} disabled={true} size={"small"} />
