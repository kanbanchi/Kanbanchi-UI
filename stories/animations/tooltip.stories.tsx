    ...
    <div className="page">
      ...
      <div>
        ...
        <div className="stories-tooltips">
          ...
          <div className="stories-tooltips__center">
            <Tooltip isPortal={isPortal} value="Direction up (default)">
              <Button variant="icon">
          ...
          <div className="stories-tooltips__left">
            <Tooltip isPortal={isPortal} value="Lorem ipsum dolor sit amet">
              <Button variant="icon">
                <Icon xlink="board-template" size={24} />
              </Button>
              <Button variant="icon">
      ...
      <section>
        ...
        <div className="stories-tooltips">
          ...
          <div className="stories-tooltips__center">
            <Tooltip isPortal={isPortal} value={longTooltip} direction="down">
              <Button variant="icon" title="Button title">
                <Icon xlink="bell" size={24} />
              </Button>
            </Tooltip>
          ...
          <div className="stories-tooltips__left">
            <Tooltip isPortal={isPortal} value={longTooltip} direction="right">
              <Button variant="icon">
                <Icon xlink="tag" size={24} />
              </Button>
            </Tooltip>
          ...
          <div className="stories-tooltips__center"></div>
          <div className="stories-tooltips__right">
            <Tooltip isPortal={isPortal} value={longTooltip} direction="left">
              <Button variant="icon">
                <Icon xlink="clear" size={24} />
              </Button>
            </Tooltip>
          ...
          <div className="stories-tooltips__center">
            <Tooltip isPortal={isPortal} value={longTooltip}>
              <Button variant="icon">
                <Icon xlink="plus" size={24} />
              </Button>
            </Tooltip>
      ...
      <section>
        ...
        <Tooltip
          ...
          link={
            <a href="#1" onClick={() => console.log("You learned more")}>
              Click to learn more
            </a>
          }
          // value={longTooltip}
        ...
        <Tooltip
          ...
          value="Connect related tasks <br/>to switch between them <br/>quickly."
          footer={
            <Button color={"white"} onClick={() => console.log("Ok")}>
              Ok
            </Button>
          }
          delayClose={500}
      ...
      <section>
        ...
        <Tooltip isPortal={isPortal} value="Test">
          <Kui.ButtonDropdown>
            <Button variant="action">Actions Right</Button>
      ...
      <section>
        ...
        <Tooltip isPortal={isPortal} value="Test">
          <Kui.ButtonsSegmented active={0} onChange={() => {}}>
            <Button>1</Button>
            <Button>2</Button>
      ...
      <section>
        ...
        <Tooltip isPortal={isPortal} value="Test">
          <Kui.Checkbox onChange={() => {}}>Test</Kui.Checkbox>
        </Tooltip>
      </section>
      ...
      <section>
        ...
        <Tooltip isPortal={isPortal} value="Test">
          <Kui.Datepicker selected={new Date()} onChange={() => {}} />
        </Tooltip>
      </section>
      ...
      <section>
        ...
        <Tooltip isPortal={isPortal} value="Test">
          <Kui.Switch checked={true} onChange={() => {}}>
            Test
          </Kui.Switch>
        </Tooltip>
      </section>
