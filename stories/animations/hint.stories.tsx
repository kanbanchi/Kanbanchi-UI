    ...
    >
      ...
      <section>
        ...
        <div className="stories-tooltips">
          ...
          <div className="stories-tooltips__center">
            <Hint value="Direction up (default)" isPortal={isPortal}>
              <Button variant="icon">
      ...
      <section>
        ...
        <div className="stories-tooltips">
          ...
          <div className="stories-tooltips__center">
            <Hint value={longTooltip} isPortal={isPortal}>
              <Button variant="icon">
                <Icon xlink="plus" size={24} />
              </Button>
            </Hint>
      ...
      <section>
        ...
        >
          ...
          <Hint
            ...
            isPortal={isPortal}
          >
            <Button variant={"icon"} onClick={() => console.log("click Dots")}>
