...
const Story = () => {
  ...
  const modalDefault = (
    ...
    >
      ...
      <Button onClick={() => setVal1(modalDefault1)}>Default1</Button>
    </Modal>
  );
  ...
  return (
    <div className="page">
      <section className="section-form-min">
        ...
        <ButtonsGroup>
          <Button onClick={() => setVal(modalDefault)}>Default</Button>
          <Button onClick={() => setVal(modalActions)}>Actions</Button>
          <Button onClick={() => setVal(modalRelease)}>Release</Button>

          <Button onClick={() => setVal(modalReleaseMini)}>Release Mini</Button>
        </ButtonsGroup>
