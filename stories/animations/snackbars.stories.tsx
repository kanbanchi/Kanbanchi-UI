  ...
  return (
    <div className="page">
      <section className="snackbars">
        <Button onClick={() => triggerQueueAddSnackbar()}>Show popup</Button>
        <br />
        <br />
        ...
        <Snackbar
          ...
          timer={55}
          text={
            "Removing Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."
          }
          buttons={[
            {
              text: "Ok",
      ...
      <Snackbar
        ...
        timer={10}
        text={
          "Card is deleted Card is deleted Card is deleted Card is deleted Card is deleted Card is deleted Card is deleted Card is deleted "
        }
        position={"left"}
        buttons={[
          {
